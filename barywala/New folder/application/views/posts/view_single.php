              ...
              <h2 class="desc-title">Details</h2>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12">
                      <p style="color: #a83d00">Total Size(Sq.ft) : <span><?php echo $item['size'];?></span></p>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <p style="color: #a83d00">Rooms : <span><?php echo $item['rooms'];?></span></p> 
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <p style="color: #a83d00">Washrooms : <span><?php echo $item['washrooms'];?></span></p> 
                    </div>
                </div>
                <div class="row">
                  <div class="col-lg-4 col-md-4 col-xs-12">
                        <p style="color: #a83d00">Rent : <span>BDT <?php echo $item['rent'];?></span></p> 
                    </div>
                </div>
