...
/*Residentials Controller To Show Different pages*/
	class Residentials extends CI_Controller
	{
		...
		public function add_residential()
		{
			...
			$this->form_validation->set_rules('rooms','No of Rooms');
			$this->form_validation->set_rules('washrooms','No of Washrooms');
			$this->form_validation->set_rules('veranda','No of Veranda');
			$this->form_validation->set_rules('parking','Parking');
			$this->form_validation->set_rules('lift','Lift');
			$this->form_validation->set_rules('gas','Gas');
			$this->form_validation->set_rules('floor','Floor No');
			$this->form_validation->set_rules('bills','Bills');
			$this->form_validation->set_rules('bachelor','Bachelor');
			$this->form_validation->set_rules('time_period','Contact Period','required');
			$this->form_validation->set_rules('contact','Contact','required');
			$this->form_validation->set_rules('image','Photo');
			$this->form_validation->set_rules('short_note','Short Description');  
