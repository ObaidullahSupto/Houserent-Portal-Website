	...
	public function add_commercial()
	{
		...
		else
		{
		    ...
		    {           
		        ...
		        $config['source_image'] = '/assets/img/posts/commercial';
		     ...
		     $this->post_model->add_commercial($image, $image1, $image2, $image3, $image4);
...
//search
	...
	public function check_image_name_exists(){

		$this->form_validation->set_message(
				'check_image_name_exists','Image Name Exist. Please rename the images different one');

			if($this->post_model->check_image_name_exists($image , $image1, $image2, $image3,$image4)){
				return true;
			}
			else{
				return false;
