 ...
 <div class="main-container section-padding"  style="background-image: url(<?php echo base_url();?>assets/img/c1.jpg)">
  <div class="search-container">
            ...
            <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-12 p-2">
                      <?php echo form_open('posts/get_post_by_city')?>
                    ...
                    <div class="dropdown-menu">
                     <?php echo form_open('posts/get_post_by_size')?>
                       <div class="row" style="margin-right: -6px; margin-left: -6px;">
                          <div class="col-md-6">
                              <select name="minimum_size" class="form-control search-slt" required="required" type>
    ...
    <div class="container-fluid" style="background:#f3f3f3;">
      <div class="container">
        <div class="row" >
          <div class="col-md-2">
              <a href="<?php echo base_url();?>posts/get_post_by_dhanmondi" class="fullwidth btn1"><b>Dhanmondi</b></a>
          </div>
          <div class="col-md-2">
            <a href="<?php echo base_url();?>posts/get_post_by_banani" class="fullwidth btn1"><b>Banani</b></a>
          </div>
          <div class="col-md-2">
            <a href="<?php echo base_url();?>posts/get_post_by_baridhara" class="fullwidth btn1"><b>Baridhara DOHS</b></a>
          </div>
          <div class="col-md-2">
            <a href="<?php echo base_url();?>posts/get_post_by_basundhara" class="fullwidth btn1"><b>Basundhara</b></a>
          </div>
          <div class="col-md-2">
            <a href="<?php echo base_url();?>posts/get_post_by_gulshan1" class="fullwidth btn1"><b>Gulshan 1</b></a> 
          </div>
          <div class="col-md-2">
            <a href="<?php echo base_url();?>posts/get_post_by_gulshan2" class="fullwidth btn1"><b>Gulshan 2</b></a>
          </div>        
        </div>    
      </div>
    </div>
...
<div class="container property">
  <div class="row" style="margin: 10px; padding: 20px;">
    <div class="col-12">
            ...
            <div class="property-wrap">
              <div class="property-item">
                <div class="item-thumb">
                  <a class="hover-effect" href="<?php echo site_url('/posts/'.$item['slug']);?>">
                  <img class="img-fluid img-thumbnail" src="<?php echo site_url(); ?>assets/img/posts/commercial/<?= $item['image'];?>" alt="" >
                  </a>
                  
                </div>
                <div class="item-body">
                  <h3 class="property-title"><a href="<?php echo site_url('/posts/'.$item['slug']);?>"><?= $item['title'];?></a></h3>
     ...
     <!--   </div>               -->
          <a href="<?php echo base_url();?>posts/all_commercial_list" class="btn btn-common">Browse All</a>
        </div>
      </div>
  </div>
</div>
